...
`contributions.svg` é gerado integralmente por `scripts/generate-contributions.mjs`, em SVG estático de 2164 × 534. Referência visual: master aprovada `codex-clipboard-7b25d087-4618-4998-8dbd-cab20af4e640.png`. Moldura, divisória superior `< | >`, texto e células são vetoriais. Fundo externo sólido `#0d1117`; divisória superior com altura reduzida em 35% e menos espaço externo; divisória inferior substituída no README pelo WebP animado do Vergil, conforme refinamento solicitado. Não há imagem de fundo rasterizada, screenshot, fonte externa, animação ou dados de exemplo no gerador.
