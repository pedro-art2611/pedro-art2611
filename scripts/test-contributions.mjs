...
assert.ok(svg.includes('viewBox="0 0 2164 534"'), 'Painel sem espaço reservado ao divisor inferior');
assert.ok(svg.includes('id="arrow-45"'), 'Divisor superior preservado');
assert.ok(!svg.includes('id="arrow-580"'), 'Divisor inferior substituído pelo WebP do Vergil no README');
